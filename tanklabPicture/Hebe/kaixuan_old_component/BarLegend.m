...
% ah3 = axes('position', get(gca,'position'),'visible','off')
 ...
 legend1 = legend([c(1) , c(2) ] , 'stream\_llc-Heracles', 'stream\_llc-Hebe'   )
ah1 = axes('position', get(gca,'position'),'visible','off')
legend2 = legend(ah1, [ c(3)  c(4), ] , 'stream\_dram-Heracles' , 'stream\_dram-Hebe')
ah2 = axes('position', get(gca,'position'),'visible','off')
legend3 = legend(ah2, [ c(5)  c(6), ] , 'lstm-Heracles' , 'lstm-Hebe')
ah3 = axes('position', get(gca,'position'),'visible','off')
legend4 = legend(ah3, [  c(7), c(8)],  'cpu\_stress-Heracles', 'cpu\_stress-Hebe')
