...
ylabel('Tail-latency (% of SLA)', 'Fontsize' ,22)
% set(gcf,'position',[200 200 500 370]) 标准值
%  set(gca,'units','normalized','position',[0.19 0.22 0.79
%  0.74],'box','off')标准值
 set(gcf,'position',[200 200 500 400]) 
 set(gca,'units','normalized','position',[0.19 0.28 0.79 0.69],'box','off')
   set(gca,'xcolor',[0 0 0]);
 set(gca,'ycolor',[0 0 0]);
 %legend content
% legend1 = legend([aa1 ,bb1], 'llc', 'dram')
...
% %legend位置
% set(legend1,...
%     'Orientation'	,'vertical' , 'Location', 'southoutside','Position',[.1, .03,.531, .038],'box','off', 'Fontsize' ,22	);
% set(legend2,...
%     'Orientation'	,'vertical' , 'Location', 'southoutside','Position',[.3, .03,.531, .038],'box','off', 'Fontsize' ,22 );
% set(legend3,...
%     'Orientation'	,'vertical' , 'Location', 'southoutside','Position',[.5 , .03,.531, .038],'box','off', 'Fontsize' ,22 );