...
%set the position of figure and axis 
 ...
 set(gca,'units','normalized','position',[0.15 0.195 0.8 0.78],'box','off')
...
% %legend位置
% set(legend1,...
%     'Orientation'	,'vertical' , 'Location', 'southoutside','Position',[.04, .13,.531, .038],'box','off'	, 'Fontsize' ,10);
% set(legend2,...
%     'Orientation'	,'vertical' , 'Location', 'southoutside','Position',[.3, .13,.531, .038],'box','off' , 'Fontsize' ,10);
% set(legend3,...
%     'Orientation'	,'vertical' , 'Location', 'southoutside','Position',[.56 , .13,.531, .038],'box','off', 'Fontsize' ,10 );
